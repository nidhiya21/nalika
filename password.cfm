                        ...
                        <form name="passwordForm" method="post" action="components/contactscript.cfc?method=validatePassword">
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="password" title="Please enter your password" placeholder="******" name="fld_new_password" id="fld_password" class="form-control">
                            </div>    
                            <div class="form-group">
                                <label class="control-label" for="password">Confirm Password</label>
                                <input type="password" title="Please enter your password" placeholder="******" name="fld_confirm_password" id="fld_password" class="form-control">

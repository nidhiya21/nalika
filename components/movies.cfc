        ...
        <cfif arrayIsEmpty(errorMessage)>	
            <cfif arguments.movieID NEQ ''>
                <cfquery name = "updateMovies"  result="res"> 
                    ...
                    fld_details = <cfqueryparam value = "#arguments.fld_details#" cfsqltype = "cf_sql_varchar">, 
                    fld_cast = <cfqueryparam value = "#arguments.fld_cast#" cfsqltype = "cf_sql_varchar">, 
                    fld_facts = <cfqueryparam value = "#arguments.fld_facts#" cfsqltype = "cf_sql_varchar">, 
            ...
            <cfelse>
                <cfquery name = "insertMoviesDetails" result="res">  
                    insert into  movies(fld_moviename,fld_poster,fld_cast,fld_facts,fld_link,fld_ratings,createdDate,userID) 
                    values(
                    ...
                    ,<cfqueryparam cfsqltype="cf_sql_varchar" value="#arguments.fld_details#" />      
                    ,<cfqueryparam cfsqltype="cf_sql_varchar" value="#arguments.fld_cast#" />  
                    ,<cfqueryparam cfsqltype="cf_sql_varchar" value="#arguments.fld_facts#" />     
